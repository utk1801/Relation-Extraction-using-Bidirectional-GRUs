...
if __name__ == '__main__':
    ...
    config = {'vocab_size': vocab_size, 'embed_dim': args.embed_dim, 'training': True, 'hidden_size': args.hidden_size,'batch_size': args.batch_size}
    ### TODO(Students END
    ...
    save_serialization_dir = os.path.join('serialization_dirs', 'advanced_lstm_drop')
